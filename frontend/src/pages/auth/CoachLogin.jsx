...
const CoachLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Prepare login data based on email or phone
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Coach Login</h2>
          <p className="mt-2 text-center text-sm text-gray-600">Sign in to your coach account</p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {/* Links for new coach or other user types */}
