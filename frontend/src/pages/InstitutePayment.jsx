...
import { FaCrown, FaCheck, FaTimes, FaCreditCard, FaBuilding } from 'react-icons/fa';
...
const InstitutePayment = () => {
  ...
  const redirectPath = location.state?.from || '/institute/dashboard';
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        localStorage.setItem('institutePaymentCompleted', 'true');
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            Complete Your Institute Registration
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Choose your plan to unlock all features and start managing your institute
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
          {plans.map((plan) => (
            ...
            >
              {plan.popular && (
                <div className="absolute top-0 right-0 bg-gradient-to-r from-orange-600 to-red-600 text-white px-4 py-2 text-sm font-medium">
          ...
          <button
            ...
            className={`w-full py-4 rounded-lg font-medium text-white transition-all ${
              loading
                ...
                : 'bg-gradient-to-r from-orange-600 to-red-600 hover:shadow-lg transform hover:scale-105'
            }`}
          >
            {loading ? (
